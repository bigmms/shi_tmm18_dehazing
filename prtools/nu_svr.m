...
%   C     Regularisation parameter (0 < C < 1): expected fraction of SV
...
%   C     Equivalent C regularisation parameter of SVM-C algorithm
%
% DESCRIPTION
% Optimises a support vector classifier for the dataset A by 
