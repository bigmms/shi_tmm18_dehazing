...
% (default = 5). It is trained with L2 regularisation using regularisation
...
% 31 Jul 2015, PRTools modifications by R. Duin
    ...
    elseif mapping_task(argin,'training')
      ...
      [A,m,k,c,lablist,K,B] = cleandset(A,1); 
...
%         checkgrad('drbm_grad', x, 1e-7, machine, cur_X, cur_lab, cur_labmat, weight_cost)
        x = minimise(x, 'drbm_grad', 9, machine, X, labels, label_matrix, weight_cost);
...
function [X, fX, i] = minimise(X, f, length, P1, P2, P3, P4, P5);

% Minimise a continuous differentialble multivariate function. Starting point
...
%
% Usage: [X, fX, i] = minimise(X, f, length, P1, P2, P3, P4, P5)
%
